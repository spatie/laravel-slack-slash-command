...
[![Build Status](https://img.shields.io/travis/spatie/laravel-slack/master.svg?style=flat-square)](https://travis-ci.org/spatie/laravel-slack)
...
``` bash
composer require spatie/laravel-slack
```
